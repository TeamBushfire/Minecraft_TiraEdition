...
public class Modelbaropodmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "baropodmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 72)
				.addBox(-12.0F, -14.0F, -32.0F, 24.0F, 28.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -6.0F, 6.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(128, 12).addBox(-6.0F, 1.5F, -18.75F, 12.0F, 12.0F, 16.0F,
		...
		PartDefinition leftarm = head.addOrReplaceChild("leftarm", CubeListBuilder.create(),
				PartPose.offset(12.0F, 9.0F, -29.0F));

		PartDefinition cube_r2 = leftarm
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(88, 0).addBox(-5.5F, -9.0F, -18.0F, 8.0F, 8.0F, 20.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-0.5F, 4.0F, 3.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r3 = leftarm.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 8)
				.addBox(-19.0F, -3.1181F, -21.996F, 12.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r5 = rightarm.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 8).mirror()
				.addBox(7.0F, -3.1181F, -21.996F, 12.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 0).mirror().addBox(-4.0F, -4.6181F, -21.996F, 16.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(130, 42).mirror()
				.addBox(-4.0F, -4.6181F, -17.996F, 4.0F, 4.0F, 18.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.0F, 8.0F, -15.0F, 0.0F, 0.6545F, 0.0F));

		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg", CubeListBuilder.create()
				.texOffs(100, 120).addBox(-9.0F, -5.0F, -6.0F, 12.0F, 32.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(12.0F, -3.0F, -2.0F));

		PartDefinition leftmiddlefrontleg = partdefinition.addOrReplaceChild("leftmiddlefrontleg", CubeListBuilder
				.create().texOffs(112, 72).addBox(-7.0F, -4.5F, -12.0F, 12.0F, 36.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(12.0F, -7.5F, 22.0F));

		PartDefinition leftmiddlebackleg = partdefinition.addOrReplaceChild("leftmiddlebackleg", CubeListBuilder
				.create().texOffs(112, 72).addBox(-7.0F, -4.0F, -6.0F, 12.0F, 36.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(12.0F, -8.0F, 30.0F));

		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg", CubeListBuilder.create()
				.texOffs(112, 72).addBox(-7.0F, -4.0F, 0.0F, 12.0F, 36.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(12.0F, -8.0F, 38.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-12.0F, -16.0F, -20.0F, 24.0F, 32.0F, 40.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -8.0F, 26.0F));

		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild("rightfrontleg",
				CubeListBuilder.create().texOffs(100, 120).mirror()
		...
		PartDefinition rightmiddlefrontleg = partdefinition.addOrReplaceChild("rightmiddlefrontleg",
				CubeListBuilder.create().texOffs(112, 72).mirror()
