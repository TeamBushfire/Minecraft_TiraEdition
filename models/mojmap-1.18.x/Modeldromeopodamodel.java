...
public class Modeldromeopodamodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dromeopodamodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -7.0F, -5.5F, 5.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(20, 18)
						.addBox(-0.5F, -3.0F, 3.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 24.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 18)
						.addBox(-2.5F, -1.0F, -5.0F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(24, 0)
						.addBox(-1.5F, 0.0F, -8.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = leftarm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(26, 27)
						.addBox(-1.0F, -3.0F, -5.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(8, 0)
						...
						.addBox(-1.5F, -3.0F, -2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 25)
						.addBox(-2.0F, -1.0F, -2.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = rightarm.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(8, 24).mirror()
				.addBox(1.0F, -3.0F, -5.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 0)
				.mirror().addBox(0.5F, -4.0F, -5.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(29, 10).mirror().addBox(0.5F, -4.0F, -4.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(0, 18).mirror()
				.addBox(0.5F, -3.0F, -2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(15, 18)
				.mirror().addBox(0.0F, -1.0F, -2.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.0F, 1.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = leftfrontleg.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F,
		...
		PartDefinition leftmiddlefrontleg = partdefinition.addOrReplaceChild("leftmiddlefrontleg",
				CubeListBuilder.create(), PartPose.offset(2.5F, 19.0F, -2.5F));
		...
		PartDefinition leftmiddlebackleg = partdefinition.addOrReplaceChild("leftmiddlebackleg",
				CubeListBuilder.create(), PartPose.offset(2.5F, 19.0F, 1.5F));
		...
		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg", CubeListBuilder.create(),
				PartPose.offset(2.5F, 19.0F, 4.5F));

		PartDefinition cube_r6 = leftbackleg
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 8.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = rightfrontleg.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 27).mirror()
						.addBox(0.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.0F, 0.0F, 0.0F, -0.3927F, 0.3927F, 0.0F));
