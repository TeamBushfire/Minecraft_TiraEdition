...
public class Modelplacostracamodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("minecraft_tira_edition", "modelplacostracamodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -9.0F, -3.0F, 7.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition head = partdefinition
				.addOrReplaceChild("head",
						CubeListBuilder.create().texOffs(22, 17).addBox(-4.0F, 1.0F, -8.0F, 7.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
								.texOffs(0, 17).addBox(-4.0F, 0.0F, -4.0F, 7.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.5F, 15.0F, -3.0F));
		PartDefinition lefteye = head.addOrReplaceChild("lefteye", CubeListBuilder.create(), PartPose.offset(2.7077F, 0.6314F, -3.3615F));
		PartDefinition cube_r1 = lefteye.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.05F, 0.15F, -2.9F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 4)
		...
		PartDefinition righteye = head.addOrReplaceChild("righteye", CubeListBuilder.create(), PartPose.offset(-3.7077F, 0.6314F, -3.3615F));
		PartDefinition cube_r2 = righteye.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.05F, 0.15F, -2.9F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 4).mirror().addBox(0.05F, 1.15F, -2.9F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.2923F, -0.6314F, 0.3615F, -0.3216F, 0.339F, -0.0788F));
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg",
				CubeListBuilder.create().texOffs(0, 27).addBox(-2.25F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild(
				"rightfrontleg", CubeListBuilder.create().texOffs(0, 27).mirror()
		...
		PartDefinition rightmiddlefrontleg = partdefinition.addOrReplaceChild(
				"rightmiddlefrontleg", CubeListBuilder.create().texOffs(0, 27).mirror()
						.addBox(-0.75F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.5F, 19.0F, -0.75F));
		PartDefinition rightmiddlebackleg = partdefinition.addOrReplaceChild(
				"rightmiddlebackleg", CubeListBuilder.create().texOffs(0, 27).mirror()
						.addBox(-0.75F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.5F, 19.0F, 2.75F));
		PartDefinition rightbackleg = partdefinition.addOrReplaceChild(
				"rightbackleg", CubeListBuilder.create().texOffs(0, 27).mirror()
						.addBox(-0.75F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.5F, 19.0F, 6.25F));
