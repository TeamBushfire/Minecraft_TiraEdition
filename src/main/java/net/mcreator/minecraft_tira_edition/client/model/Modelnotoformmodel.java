...
public class Modelnotoformmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("minecraft_tira_edition", "modelnotoformmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -7.0F, 1.0F, 6.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, -5.0F));
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 17.0F, -4.0F));
		PartDefinition lefteyes = head.addOrReplaceChild("lefteyes", CubeListBuilder.create(), PartPose.offset(0.25F, 0.0F, -2.75F));
		PartDefinition cube_r1 = lefteyes.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(20, 0).addBox(-2.5F, -0.25F, -2.75F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 4)
		...
		PartDefinition righteyes = head.addOrReplaceChild("righteyes", CubeListBuilder.create(), PartPose.offset(-0.25F, 0.0F, -2.75F));
		PartDefinition cube_r2 = righteyes.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(20, 0).mirror().addBox(0.5F, -0.25F, -2.75F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(20, 4).mirror().addBox(0.5F, 0.75F, -2.75F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.25F, 0.5F, 0.75F, -0.3289F, 0.3736F, -0.1239F));
		PartDefinition leftarm = head
				.addOrReplaceChild(
						"leftarm", CubeListBuilder.create().texOffs(12, 13).addBox(0.0F, 0.0F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
								.texOffs(0, 14).addBox(0.5F, 0.0F, -11.0F, 0.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.25F, 1.0F, -3.0F));
		PartDefinition rightarm = head.addOrReplaceChild("rightarm",
				CubeListBuilder.create().texOffs(12, 13).mirror().addBox(-1.0F, 0.0F, -6.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(0, 14).mirror().addBox(-0.5F, 0.0F, -11.0F, 0.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-0.25F, 1.0F, -3.0F));
		PartDefinition leftmandibles = head.addOrReplaceChild("leftmandibles",
				CubeListBuilder.create().texOffs(23, 23).addBox(-1.0F, 0.0F, -3.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.25F, 2.0F, -3.0F));
		PartDefinition rightmandibles = head.addOrReplaceChild("rightmandibles", CubeListBuilder.create().texOffs(23, 23).mirror()
				.addBox(0.0F, 0.0F, -3.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.25F, 2.0F, -3.0F));
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, 20.0F, -4.0F));
		PartDefinition leftmiddlefrontleg = partdefinition.addOrReplaceChild("leftmiddlefrontleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.25F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, 0.0F, -0.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, 20.0F, 3.0F));
		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild("rightfrontleg",
				CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-0.5F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.0F, 20.0F, -4.0F));
		PartDefinition rightmiddlefrontleg = partdefinition.addOrReplaceChild(
				"rightmiddlefrontleg", CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(-0.75F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.0F, 20.0F, -1.5F));
		PartDefinition rightmiddlebackleg = partdefinition.addOrReplaceChild("rightmiddlebackleg", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-0.75F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 20.0F, 1.0F));
		PartDefinition rightbackleg = partdefinition.addOrReplaceChild("rightbackleg",
				CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-0.5F, 0.0F, -0.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.0F, 20.0F, 3.0F));
