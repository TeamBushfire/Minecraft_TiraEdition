...
public class Modelxerostracamodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("minecraft_tira_edition", "modelxerostracamodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -6.0F, -3.0F, 7.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(13, 15).addBox(-2.5F, 1.0F, -6.0F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(22, 0)
						.addBox(0.5F, 0.0F, -9.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(22, 0).mirror()
						.addBox(-1.5F, 0.0F, -9.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 12)
						.addBox(-2.5F, 0.0F, -3.0F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 19.0F, -3.0F));
		PartDefinition lefteye = head.addOrReplaceChild("lefteye", CubeListBuilder.create(), PartPose.offset(2.4577F, 1.3814F, -1.3615F));
		PartDefinition cube_r1 = lefteye.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 18).addBox(-2.05F, 0.15F, -2.9F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 23)
		...
		PartDefinition righteye = head.addOrReplaceChild("righteye", CubeListBuilder.create(), PartPose.offset(-2.4577F, 1.3814F, -1.3615F));
		PartDefinition cube_r2 = righteye.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 18).mirror().addBox(0.05F, 0.15F, -2.9F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(0, 23).mirror().addBox(0.05F, 1.15F, -2.9F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.0423F, -1.3814F, -0.6385F, -0.3216F, 0.339F, -0.0788F));
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 0.0F, -1.25F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.25F, 20.0F, -3.0F));
		PartDefinition leftmiddlefrontleg = partdefinition.addOrReplaceChild("leftmiddlefrontleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.25F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.75F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightmiddlebackleg = partdefinition.addOrReplaceChild(
				"rightmiddlebackleg", CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(-1.75F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.5F, 20.0F, 2.25F));
		PartDefinition rightbackleg = partdefinition.addOrReplaceChild("rightbackleg", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-1.25F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 20.0F, 5.0F));
