...
public class ModelThyreostracamodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("minecraft_tira_edition", "model_thyreostracamodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -12.0F, -3.0F, 8.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 22).addBox(-4.0F, -6.0F, -3.0F, 8.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 23)
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(22, 22).addBox(-2.5F, -1.5F, -4.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.5F, -3.0F, 0.1745F, 0.0F, 0.0F));
		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 34).mirror().addBox(-0.25F, -0.25F, -2.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(10, 34).mirror().addBox(-0.25F, 0.75F, -2.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-2.9631F, -6.1311F, -2.8179F, -0.1806F, 0.2577F, -0.0465F));
		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 34).addBox(-1.75F, -0.25F, -2.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(10, 34)
		...
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg",
				CubeListBuilder.create().texOffs(31, 30).addBox(-1.0F, -1.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 20.0F, -2.5F));
		PartDefinition leftmiddlefrontleg = partdefinition.addOrReplaceChild("leftmiddlefrontleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -1.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.5F, 19.0F, 9.0F));
		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild(
				"rightfrontleg", CubeListBuilder.create().texOffs(31, 30).mirror()
						.addBox(-2.0F, -1.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-4.0F, 20.0F, -2.5F));
		PartDefinition rightmiddlefrontleg = partdefinition.addOrReplaceChild("rightmiddlefrontleg", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-3.0F, -1.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 19.0F, 2.0F));
		PartDefinition rightmiddlebackleg = partdefinition.addOrReplaceChild("rightmiddlebackleg", CubeListBuilder.create().texOffs(0, 0).mirror()
				.addBox(-3.0F, -1.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 19.0F, 6.5F));
		PartDefinition rightbackleg = partdefinition.addOrReplaceChild("rightbackleg",
				CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.5F, -1.0F, 0.0F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-2.5F, 19.0F, 9.0F));
