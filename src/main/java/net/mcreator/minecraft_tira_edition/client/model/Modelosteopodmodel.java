...
public class Modelosteopodmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("minecraft_tira_edition", "modelosteopodmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 10).addBox(-2.5F, -5.0F, 0.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 23.25F, -3.0F));
		PartDefinition head = partdefinition
				.addOrReplaceChild(
						"head", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, 0.0F, -6.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
								.texOffs(0, 20).addBox(-1.5F, 1.0F, -8.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 18.25F, -3.0F));
		PartDefinition leftarm = head
				.addOrReplaceChild(
						"leftarm", CubeListBuilder.create().texOffs(0, 0).addBox(0.5F, -1.0F, -5.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
								.texOffs(0, 10).addBox(0.0F, -1.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(2.5F, 3.0F, -3.0F));
		PartDefinition rightarm = head.addOrReplaceChild("rightarm",
				CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-0.5F, -1.0F, -5.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 10).mirror().addBox(-1.0F, -1.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-2.5F, 3.0F, -3.0F));
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg", CubeListBuilder.create(),
				PartPose.offset(2.5F, 21.25F, -4.0F));
		PartDefinition cube_r1 = leftfrontleg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(16, 0).addBox(0.0F, -1.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild("rightfrontleg", CubeListBuilder.create(),
				PartPose.offset(-2.5F, 21.25F, -4.0F));
		PartDefinition cube_r2 = rightfrontleg
				.addOrReplaceChild(
						"cube_r2", CubeListBuilder.create().texOffs(16, 0).mirror()
		...
		PartDefinition leftmiddlefrontleg = partdefinition.addOrReplaceChild("leftmiddlefrontleg", CubeListBuilder.create(),
				PartPose.offset(2.5F, 21.25F, -2.0F));
		...
		PartDefinition rightmiddlefrontleg = partdefinition.addOrReplaceChild("rightmiddlefrontleg", CubeListBuilder.create(),
				PartPose.offset(-2.5F, 21.25F, -2.0F));
		PartDefinition cube_r4 = rightmiddlefrontleg
				.addOrReplaceChild(
						"cube_r4", CubeListBuilder.create().texOffs(16, 0).mirror()
								.addBox(-4.0F, -1.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2849F, -0.274F, -0.8249F));
		PartDefinition leftmiddlebackleg = partdefinition.addOrReplaceChild("leftmiddlebackleg", CubeListBuilder.create(),
				PartPose.offset(2.5F, 21.25F, 0.0F));
		...
		PartDefinition rightmiddlebackleg = partdefinition.addOrReplaceChild("rightmiddlebackleg", CubeListBuilder.create(),
				PartPose.offset(-2.5F, 21.25F, 0.0F));
		PartDefinition cube_r6 = rightmiddlebackleg
				.addOrReplaceChild(
						"cube_r6", CubeListBuilder.create().texOffs(16, 0).mirror()
								.addBox(-4.0F, -1.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.7854F));
		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg", CubeListBuilder.create(), PartPose.offset(2.5F, 21.25F, 2.0F));
		...
		PartDefinition rightbackleg = partdefinition.addOrReplaceChild("rightbackleg", CubeListBuilder.create(),
				PartPose.offset(-2.5F, 21.25F, 2.0F));
		PartDefinition cube_r8 = rightbackleg
				.addOrReplaceChild(
						"cube_r8", CubeListBuilder.create().texOffs(16, 0).mirror()
								.addBox(-4.0F, -1.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1872F, 0.1841F, -0.8027F));
