...
public class Modeleuleptopodamodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("minecraft_tira_edition", "modeleuleptopodamodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 12.0F, -5.0F));
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 6).addBox(-1.5F, -3.0F, -11.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 19)
		...
		PartDefinition cube_r2 = leftarm.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(27, 6).addBox(2.0F, -1.0F, -11.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(2.5F, -4.5F, -17.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(2.5F, -4.5F, -16.0F, 1.0F,
		...
		PartDefinition cube_r3 = rightarm.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(27, 6).mirror().addBox(-4.0F, -1.0F, -11.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(0, 0).mirror().addBox(-3.5F, -3.5F, -12.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 16).mirror().addBox(-3.0F, -3.5F, -17.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(7, 0)
						.mirror().addBox(-3.5F, -4.5F, -17.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 0).mirror()
						.addBox(-3.5F, -4.5F, -16.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.0F, -3.137F, 6.0689F, 0.48F, 0.0F, 0.0F));
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg",
				CubeListBuilder.create().texOffs(30, 19).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 13.0F, -6.0F));
		PartDefinition leftmiddlefrontleg = partdefinition.addOrReplaceChild("leftmiddlefrontleg",
				CubeListBuilder.create().texOffs(30, 19).addBox(-2.5F, 0.0F, -3.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 13.0F, -0.5F));
		PartDefinition leftmiddlebackleg = partdefinition.addOrReplaceChild("leftmiddlebackleg",
				CubeListBuilder.create().texOffs(30, 19).addBox(-2.5F, 0.0F, -1.5F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 13.0F, 2.0F));
		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg",
				CubeListBuilder.create().texOffs(30, 19).addBox(-2.5F, 0.0F, 0.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 13.0F, 4.5F));
		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild(
				"rightfrontleg", CubeListBuilder.create().texOffs(30, 19).mirror()
		...
		PartDefinition rightmiddlefrontleg = partdefinition.addOrReplaceChild(
				"rightmiddlefrontleg", CubeListBuilder.create().texOffs(30, 19).mirror()
						.addBox(-0.5F, 0.0F, -3.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.5F, 13.0F, -0.5F));
		PartDefinition rightmiddlebackleg = partdefinition.addOrReplaceChild("rightmiddlebackleg", CubeListBuilder.create().texOffs(30, 19).mirror()
				.addBox(-0.5F, 0.0F, -1.5F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.5F, 13.0F, 2.0F));
		PartDefinition rightbackleg = partdefinition.addOrReplaceChild("rightbackleg", CubeListBuilder.create().texOffs(30, 19).mirror()
				.addBox(-0.5F, 0.0F, 0.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.5F, 13.0F, 4.5F));
		PartDefinition body = partdefinition
				.addOrReplaceChild(
						"body", CubeListBuilder.create().texOffs(27, 0).addBox(-2.5F, 3.0F, 3.0F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-3.5F, -3.0F, -6.0F, 7.0F, 6.0F, 13.0F, new CubeDeformation(0.0F)),
