...
public class Modelallobrachidmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("minecraft_tira_edition", "modelallobrachidmodel"), "main");
	public final ModelPart head;
	public final ModelPart leftlegarm;
	public final ModelPart leftfrontleg;
	public final ModelPart leftmiddleleg;
	public final ModelPart leftbackleg;
	public final ModelPart body;
	public final ModelPart rightlegarm;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(29, 8).addBox(-1.5F, -1.0F, -9.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 21)
		...
		PartDefinition cube_r2 = leftarm.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(29, 0).addBox(1.5F, -2.0F, -11.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(18, 34)
						...
						.addBox(2.0F, -4.5F, -16.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(19, 21).addBox(2.0F, -4.5F, -15.0F, 2.0F,
		...
		PartDefinition cube_r3 = rightarm.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(29, 0).mirror().addBox(-4.5F, -2.0F, -11.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(18, 34).mirror().addBox(-4.0F, -2.5F, -13.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(0, 19).mirror().addBox(-3.0F, -3.5F, -16.0F, 0.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(11, 35).mirror().addBox(-4.0F, -4.5F, -16.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(19, 21).mirror().addBox(-4.0F, -4.5F, -15.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(3.0F, -3.0068F, 6.8142F, 0.48F, 0.0F, 0.0F));
		PartDefinition leftlegarm = partdefinition
				.addOrReplaceChild("leftlegarm",
						CubeListBuilder.create().texOffs(26, 30).addBox(-2.5F, 0.0F, -1.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
								.texOffs(0, 34).addBox(-2.5F, 3.0F, -3.0F, 3.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(3.5F, 13.0F, -7.0F));
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 13.0F, -2.75F));
		PartDefinition leftmiddleleg = partdefinition.addOrReplaceChild("leftmiddleleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, 0.0F, -1.5F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 13.0F, 1.25F));
		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, 0.0F, -1.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.5F, 13.0F, 5.25F));
		PartDefinition body = partdefinition.addOrReplaceChild(
				"body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -5.25F, -7.75F, 7.0F, 6.0F, 15.0F, new CubeDeformation(0.0F))
						.texOffs(26, 21).addBox(-2.5F, 0.75F, 1.25F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 15.25F, 0.75F));
		PartDefinition rightlegarm = partdefinition.addOrReplaceChild("rightlegarm",
				CubeListBuilder.create().texOffs(26, 30).mirror().addBox(-0.5F, 0.0F, -1.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(0, 34).mirror().addBox(-0.5F, 3.0F, -3.0F, 3.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.5F, 13.0F, -7.0F));
		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild(
				"rightfrontleg", CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(-0.5F, 0.0F, -2.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-3.5F, 13.0F, -2.75F));
		PartDefinition rightmiddleleg = partdefinition.addOrReplaceChild(
				"rightmiddleleg", CubeListBuilder.create().texOffs(0, 0).mirror()
		...
		PartDefinition rightbackleg = partdefinition.addOrReplaceChild(
				"rightbackleg", CubeListBuilder.create().texOffs(0, 0).mirror()
