...
public class CryptophytablockupdatetickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z)).isFaceSturdy(world, new BlockPos((int) x, (int) (y + 1), (int) z),
				...
				|| (world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getFluidState().isSource()) {
			{
				...
				BlockState _bs = MinecraftTiraEditionModBlocks.TIRADIRT_3.get().defaultBlockState();
			...
			if ((world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z))).getBlock() == MinecraftTiraEditionModBlocks.TIRADIRT_3.get()
				...
				world.setBlock(new BlockPos((int) (x + 1), (int) y, (int) z),
						MinecraftTiraEditionModBlocks.CRYPTOPHYTEBLOCK.get().defaultBlockState(), 3);
			}
			if ((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == MinecraftTiraEditionModBlocks.TIRADIRT_3.get()
					&& world.isEmptyBlock(new BlockPos((int) (x - 1), (int) (y + 1), (int) z)) == true && Math.random() < 0.3) {
				world.setBlock(new BlockPos((int) (x - 1), (int) y, (int) z),
			...
			if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)))).getBlock() == MinecraftTiraEditionModBlocks.TIRADIRT_3.get()
			...
			if ((world.getBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) z))).getBlock() == MinecraftTiraEditionModBlocks.TIRADIRT_3
			...
			if ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) (z + 1)))).getBlock() == MinecraftTiraEditionModBlocks.TIRADIRT_3
