...
public class Eucalophytacaea2Feature extends Feature<NoneFeatureConfiguration> {
	public static Eucalophytacaea2Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Eucalophytacaea2Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:eucalophytacaea_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:eucalophytacaea_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("minecraft_tira_edition:densealtiphytejungle"),
			...
			new ResourceLocation("minecraft_tira_edition:tropicalaltiphyteforest"), new ResourceLocation("minecraft_tira_edition:tiraswamp"));
	...
	public Eucalophytacaea2Feature() {
