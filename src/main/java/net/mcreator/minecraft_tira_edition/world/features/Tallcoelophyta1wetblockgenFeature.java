...
public class Tallcoelophyta1wetblockgenFeature extends Feature<NoneFeatureConfiguration> {
	public static Tallcoelophyta1wetblockgenFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Tallcoelophyta1wetblockgenFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:tallcoelophyta_1wetblockgen", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:tallcoelophyta_1wetblockgen", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Tallcoelophyta1wetblockgenFeature() {
