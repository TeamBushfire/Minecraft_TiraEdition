...
public class Mediumaltiphyte8x82Feature extends Feature<NoneFeatureConfiguration> {
	public static Mediumaltiphyte8x82Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Mediumaltiphyte8x82Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:mediumaltiphyte_8x_82", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:mediumaltiphyte_8x_82", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Mediumaltiphyte8x82Feature() {
