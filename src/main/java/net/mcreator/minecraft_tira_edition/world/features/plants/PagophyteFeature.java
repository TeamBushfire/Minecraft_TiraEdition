...
public class PagophyteFeature extends RandomPatchFeature {
	public static PagophyteFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new PagophyteFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:pagophyte", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(BlockStateProvider.simple(MinecraftTiraEditionModBlocks.PAGOPHYTE.get().defaultBlockState())),
						List.of(), 270));
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:pagophyte", CONFIGURED_FEATURE,
