...
public class TirandirtFeature extends OreFeature {
	public static TirandirtFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TirandirtFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:tirandirt", FEATURE,
				new OreConfiguration(TirandirtFeatureRuleTest.INSTANCE, MinecraftTiraEditionModBlocks.TIRANDIRT.get().defaultBlockState(), 64));
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:tirandirt", CONFIGURED_FEATURE,
	...
	private static class TirandirtFeatureRuleTest extends RuleTest {
		static final TirandirtFeatureRuleTest INSTANCE = new TirandirtFeatureRuleTest();
		private static final com.mojang.serialization.Codec<TirandirtFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<TirandirtFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraft_tira_edition:tirandirt_match"), CUSTOM_MATCH);
		}
