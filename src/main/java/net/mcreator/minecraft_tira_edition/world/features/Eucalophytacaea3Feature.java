...
public class Eucalophytacaea3Feature extends Feature<NoneFeatureConfiguration> {
	public static Eucalophytacaea3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Eucalophytacaea3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:eucalophytacaea_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:eucalophytacaea_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Eucalophytacaea3Feature() {
