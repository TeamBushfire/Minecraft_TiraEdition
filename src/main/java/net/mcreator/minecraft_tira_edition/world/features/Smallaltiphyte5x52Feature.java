...
public class Smallaltiphyte5x52Feature extends Feature<NoneFeatureConfiguration> {
	public static Smallaltiphyte5x52Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Smallaltiphyte5x52Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:smallaltiphyte_5x_52", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:smallaltiphyte_5x_52", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Smallaltiphyte5x52Feature() {
