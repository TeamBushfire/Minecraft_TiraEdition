...
public class BrachyphytaFeature extends RandomPatchFeature {
	public static BrachyphytaFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BrachyphytaFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:brachyphyta", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(BlockStateProvider.simple(MinecraftTiraEditionModBlocks.BRACHYPHYTA.get().defaultBlockState())),
						List.of(), 270));
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:brachyphyta", CONFIGURED_FEATURE,
				List.of(InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, CountPlacement.of(40)));
		return FEATURE;
	}
