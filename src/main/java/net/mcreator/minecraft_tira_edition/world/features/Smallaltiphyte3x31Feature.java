...
public class Smallaltiphyte3x31Feature extends Feature<NoneFeatureConfiguration> {
	public static Smallaltiphyte3x31Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Smallaltiphyte3x31Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:smallaltiphyte_3x_31", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:smallaltiphyte_3x_31", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Smallaltiphyte3x31Feature() {
