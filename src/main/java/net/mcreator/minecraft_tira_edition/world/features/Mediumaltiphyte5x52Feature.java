...
public class Mediumaltiphyte5x52Feature extends Feature<NoneFeatureConfiguration> {
	public static Mediumaltiphyte5x52Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Mediumaltiphyte5x52Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:mediumaltiphyte_5x_52", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:mediumaltiphyte_5x_52", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Mediumaltiphyte5x52Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("minecraft_tira_edition", "mediumaltiphyte5x5"));
		if (template == null)
			return false;
