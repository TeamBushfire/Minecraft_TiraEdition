...
public class Altiphyte14x142Feature extends Feature<NoneFeatureConfiguration> {
	public static Altiphyte14x142Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Altiphyte14x142Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:altiphyte_14x_142", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:altiphyte_14x_142", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
