...
public class Mediumaltiphyte8x81Feature extends Feature<NoneFeatureConfiguration> {
	public static Mediumaltiphyte8x81Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Mediumaltiphyte8x81Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:mediumaltiphyte_8x_81", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:mediumaltiphyte_8x_81", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Mediumaltiphyte8x81Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("minecraft_tira_edition", "mediumaltiphyte8x8"));
		if (template == null)
			return false;
