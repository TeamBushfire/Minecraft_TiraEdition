...
public class DensealtiphytejungleLeaveDecorator extends LeaveVineDecorator {
	public static final DensealtiphytejungleLeaveDecorator INSTANCE = new DensealtiphytejungleLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("densealtiphytejungle_tree_leave_decorator");
