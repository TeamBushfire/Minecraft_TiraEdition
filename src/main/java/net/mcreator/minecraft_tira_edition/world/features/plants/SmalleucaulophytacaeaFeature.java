...
public class SmalleucaulophytacaeaFeature extends RandomPatchFeature {
	public static SmalleucaulophytacaeaFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SmalleucaulophytacaeaFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:smalleucaulophytacaea", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(
								BlockStateProvider.simple(MinecraftTiraEditionModBlocks.SMALLEUCAULOPHYTACAEA.get().defaultBlockState())),
						List.of(), 5));
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:smalleucaulophytacaea", CONFIGURED_FEATURE,
	...
	public SmalleucaulophytacaeaFeature() {
