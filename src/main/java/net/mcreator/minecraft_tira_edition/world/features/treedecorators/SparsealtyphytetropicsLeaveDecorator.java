...
public class SparsealtyphytetropicsLeaveDecorator extends LeaveVineDecorator {
	public static final SparsealtyphytetropicsLeaveDecorator INSTANCE = new SparsealtyphytetropicsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sparsealtyphytetropics_tree_leave_decorator");
