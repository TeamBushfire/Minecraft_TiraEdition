...
public class Smallaltiphyte3x32Feature extends Feature<NoneFeatureConfiguration> {
	public static Smallaltiphyte3x32Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Smallaltiphyte3x32Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:smallaltiphyte_3x_32", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:smallaltiphyte_3x_32", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Smallaltiphyte3x32Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("minecraft_tira_edition", "smallaltiphyte3x3"));
		if (template == null)
			return false;
