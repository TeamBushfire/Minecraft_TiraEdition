...
public class Mediumaltiphyte5x51Feature extends Feature<NoneFeatureConfiguration> {
	public static Mediumaltiphyte5x51Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Mediumaltiphyte5x51Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:mediumaltiphyte_5x_51", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:mediumaltiphyte_5x_51", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Mediumaltiphyte5x51Feature() {
