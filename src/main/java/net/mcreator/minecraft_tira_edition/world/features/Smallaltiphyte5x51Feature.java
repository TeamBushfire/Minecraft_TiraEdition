...
public class Smallaltiphyte5x51Feature extends Feature<NoneFeatureConfiguration> {
	public static Smallaltiphyte5x51Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Smallaltiphyte5x51Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:smallaltiphyte_5x_51", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:smallaltiphyte_5x_51", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Smallaltiphyte5x51Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("minecraft_tira_edition", "smallaltiphyte5x5"));
		if (template == null)
			return false;
