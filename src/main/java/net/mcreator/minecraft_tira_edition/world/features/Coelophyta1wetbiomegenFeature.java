...
public class Coelophyta1wetbiomegenFeature extends Feature<NoneFeatureConfiguration> {
	public static Coelophyta1wetbiomegenFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Coelophyta1wetbiomegenFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:coelophyta_1wetbiomegen", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:coelophyta_1wetbiomegen", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Coelophyta1wetbiomegenFeature() {
