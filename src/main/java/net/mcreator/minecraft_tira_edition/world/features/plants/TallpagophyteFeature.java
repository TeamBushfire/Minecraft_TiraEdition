...
public class TallpagophyteFeature extends RandomPatchFeature {
	public static TallpagophyteFeature FEATURE = null;
	public static Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TallpagophyteFeature();
		CONFIGURED_FEATURE = FeatureUtils
				.register("minecraft_tira_edition:tallpagophyte", FEATURE,
						FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
								new SimpleBlockConfiguration(
										BlockStateProvider.simple(MinecraftTiraEditionModBlocks.TALLPAGOPHYTE.get().defaultBlockState())),
								List.of(), 5));
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:tallpagophyte", CONFIGURED_FEATURE,
