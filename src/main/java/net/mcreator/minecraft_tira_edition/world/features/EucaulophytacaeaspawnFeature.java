...
public class EucaulophytacaeaspawnFeature extends Feature<NoneFeatureConfiguration> {
	public static EucaulophytacaeaspawnFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new EucaulophytacaeaspawnFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:eucaulophytacaeaspawn", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:eucaulophytacaeaspawn", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public EucaulophytacaeaspawnFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(MinecraftTiraEditionModBlocks.BRACHYPHYTABLOCK.get(), MinecraftTiraEditionModBlocks.TIRANDIRT.get());
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("minecraft_tira_edition", "eucalophytacaea"));
		if (template == null)
			return false;
