...
public class Smallcoelophyta1wetbiomegenFeature extends Feature<NoneFeatureConfiguration> {
	public static Smallcoelophyta1wetbiomegenFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Smallcoelophyta1wetbiomegenFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:smallcoelophyta_1wetbiomegen", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:smallcoelophyta_1wetbiomegen", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Smallcoelophyta1wetbiomegenFeature() {
