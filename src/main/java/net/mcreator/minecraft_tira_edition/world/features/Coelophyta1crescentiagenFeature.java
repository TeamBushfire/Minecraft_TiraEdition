...
public class Coelophyta1crescentiagenFeature extends Feature<NoneFeatureConfiguration> {
	public static Coelophyta1crescentiagenFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Coelophyta1crescentiagenFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minecraft_tira_edition:coelophyta_1crescentiagen", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minecraft_tira_edition:coelophyta_1crescentiagen", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public Coelophyta1crescentiagenFeature() {
