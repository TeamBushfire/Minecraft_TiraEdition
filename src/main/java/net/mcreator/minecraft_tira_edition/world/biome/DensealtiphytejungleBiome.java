...
import net.mcreator.minecraft_tira_edition.world.features.treedecorators.DensealtiphytejungleTrunkDecorator;
import net.mcreator.minecraft_tira_edition.world.features.treedecorators.DensealtiphytejungleLeaveDecorator;
...
public class DensealtiphytejungleBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				"minecraft_tira_edition:tree_densealtiphytejungle",
				FeatureUtils.register("minecraft_tira_edition:tree_densealtiphytejungle", Feature.TREE,
						new TreeConfiguration.TreeConfigurationBuilder(
								...
								new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2)).decorators(
										ImmutableList.of(DensealtiphytejungleLeaveDecorator.INSTANCE, DensealtiphytejungleTrunkDecorator.INSTANCE))
										.build()),
				List.of(CountPlacement.of(255), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(MinecraftTiraEditionModBiomes.DENSEALTIPHYTEJUNGLE.get())),
