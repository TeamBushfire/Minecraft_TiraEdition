...
public class NodophyteplainsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("minecraft_tira_edition:tree_nodophyteplains",
						FeatureUtils.register("minecraft_tira_edition:tree_nodophyteplains", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										BlockStateProvider.simple(MinecraftTiraEditionModBlocks.NODOPHYTE_LOG.get().defaultBlockState()),
										new GiantTrunkPlacer(4, 2, 14),
										BlockStateProvider.simple(MinecraftTiraEditionModBlocks.NODOPHYTE_LEAVES.get().defaultBlockState()),
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(MinecraftTiraEditionModBiomes.NODOPHYTEPLAINS.get())),
