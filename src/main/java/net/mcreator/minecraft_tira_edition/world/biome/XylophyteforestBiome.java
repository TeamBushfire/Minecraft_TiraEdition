...
public class XylophyteforestBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(12638463).waterColor(4159204).waterFogColor(329011).skyColor(7972607)
				.foliageColorOverride(10387789).grassColorOverride(9470285).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("minecraft_tira_edition:tree_xylophyteforest",
						FeatureUtils.register("minecraft_tira_edition:tree_xylophyteforest", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										...
										new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
												.ignoreVines().build()),
						List.of(CountPlacement.of(250), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(MinecraftTiraEditionModBiomes.XYLOPHYTEFOREST.get())),
