...
public class SnowynodophyteplainsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("minecraft_tira_edition:tree_snowynodophyteplains",
						FeatureUtils.register("minecraft_tira_edition:tree_snowynodophyteplains", Feature.TREE,
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(MinecraftTiraEditionModBiomes.SNOWYNODOPHYTEPLAINS.get())),
