...
import net.mcreator.minecraft_tira_edition.world.features.treedecorators.AltiphytetropichillsTrunkDecorator;
import net.mcreator.minecraft_tira_edition.world.features.treedecorators.AltiphytetropichillsLeaveDecorator;
...
public class AltiphytetropichillsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				"minecraft_tira_edition:tree_altiphytetropichills",
				FeatureUtils.register("minecraft_tira_edition:tree_altiphytetropichills", Feature.TREE,
						new TreeConfiguration.TreeConfigurationBuilder(
								...
								new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2)).decorators(
										ImmutableList.of(AltiphytetropichillsLeaveDecorator.INSTANCE, AltiphytetropichillsTrunkDecorator.INSTANCE))
										.build()),
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(MinecraftTiraEditionModBiomes.ALTIPHYTETROPICHILLS.get())),
