...
import net.mcreator.minecraft_tira_edition.world.features.treedecorators.SparsealtyphytetropicsTrunkDecorator;
import net.mcreator.minecraft_tira_edition.world.features.treedecorators.SparsealtyphytetropicsLeaveDecorator;
...
public class SparsealtyphytetropicsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("minecraft_tira_edition:tree_sparsealtyphytetropics",
						FeatureUtils.register("minecraft_tira_edition:tree_sparsealtyphytetropics", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										...
										new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2))
												.decorators(ImmutableList.of(SparsealtyphytetropicsLeaveDecorator.INSTANCE,
														SparsealtyphytetropicsTrunkDecorator.INSTANCE))
												.build()),
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY,
						BuiltinRegistries.BIOME.getKey(MinecraftTiraEditionModBiomes.SPARSEALTYPHYTETROPICS.get())),
				BiomeDictionary.Type.JUNGLE, BiomeDictionary.Type.SPARSE);
	}
}
